...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_path', type=str, help='path to json file.', default="./trainval2all.json")
    parser.add_argument('--output', type=str, help='path to output xml files.', default="./trainvalxml")
